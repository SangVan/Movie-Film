...
export default function Footer(props) {
    ...
    return (
        <footer className="py-6 dark:bg-gray-800 text-white bg-gray-700" >
                ...
                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start text-white">
                            ...
                            <span className="self-center text-2xl font-semibold">Booking ticket movie</span>
                        </a>
                        <p className="text-xl">Lầu 6, Toà nhà Phú Mỹ Hưng, số 8 Hoàng Văn Thái
                        , khu phố 1, Phường Tân Phú, Quận 7, Thành phố Hồ Chí Minh</p>
                        <img src="https://static.mservice.io/blogscontents/momo-upload-api-210629153623-637605777831780706.png" />
                    </div>
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        <p className="pb-1 text-lg font-medium">CHĂM SÓC KHÁCH HÀNG</p>
                        <ul>
                            <li>
                                <span style={{fontSize:16}}>Địa chỉ: </span>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-white">Tầng M, Tòa nhà Petroland, Số 12 Tân Trào, Phường Tân Phú, Quận 7, Thành phố Hồ Chí Minh</a>
                            </li>
                            <li>
                                <span style={{fontSize:16}}>Email: </span>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-white">vansangdangiuh@gmail.com</a>
                            </li>
